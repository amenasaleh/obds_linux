...
-s 2 \
-p --countReadPairs \
-a /project/ndcn1484/linux/2_rnaseq/2_genome/Mus_musculus.GRCm38.102.gtf.gz \
-o GRCm39_113_counts.txt \
/project/ndcn1484/linux/2_rnaseq/3_analysis/cd4_rep1.sorted.bam
