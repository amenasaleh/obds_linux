...
--threads 8 \
--rna-strandness RF \
--summary-file 2_mapping/stats.txt \
-S 2_mapping/cd4_rep1.sam \
-1 /project/ndcn1484/linux/2_rnaseq/1_fastq/cd4_rep1_read1.fastq.gz \
-2 /project/ndcn1484/linux/2_rnaseq/1_fastq/cd4_rep1_read2.fastq.gz
