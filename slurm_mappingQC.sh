...
samtools view -@ 8 -b /project/ndcn1484/linux/2_rnaseq/3_analysis/2_mapping/cd4_rep1.sam > cd4_rep1.bam
samtools sort -@ 8 cd4_rep1.bam > cd4_rep1.sorted.bam
samtools index cd4_rep1.sorted.bam
samtools idxstats cd4_rep1.sorted.bam > cd4_rep1.idxstats
samtools flagstat cd4_rep1.sorted.bam > cd4_rep1.flagstat
